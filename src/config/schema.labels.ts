...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "auth.externalCliRecovery": "External CLI OAuth Recovery",
  "auth.externalCliRecovery.openaiCodex": "Recover OpenAI OAuth from Codex CLI",
  acp: "ACP",
  ...
  "agents.defaults.transientRetry": "Transient Retry",
  "agents.defaults.transientRetry.maxAttempts": "Transient Retry Max Attempts",
  "agents.entries.*.transientRetry": "Agent Transient Retry",
  "agents.entries.*.transientRetry.maxAttempts": "Agent Transient Retry Max Attempts",
