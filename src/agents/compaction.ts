...
// Security fix: do NOT instruct LLM to preserve 'Token' or 'API key' in compaction
// summaries. See 4.27 commit 79d42f18b86 for upstream rationale.
const IDENTIFIER_PRESERVATION_INSTRUCTIONS_ZH =
  "保留所有不透明标识符原样不变（不得缩短或重构），包括：UUID、哈希、ID、主机名、IP、端口、URL、文件名。";

// Use Chinese instructions by default for the local Chinese-speaking OpenClaw instance.
