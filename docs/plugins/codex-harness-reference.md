...
<Note>
The current bundled harness is `@openai/codex` `0.153.4`. See the
[2026-09-07 catalog verification](/plugins/codex-harness#managed-model-catalog-verification-2026-09-07)
